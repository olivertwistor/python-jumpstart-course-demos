...
class Dragon(FlyingAnimal):
    """
    A dragon is a special kind of flying animal, in that because of its scales,
    its defense modifier is increased.
    """

    def __init__(self, name: str, level: int):
        """
        Creates a dragon with a name/identifier and a level. Adds a random d4
        roll to flying animals' usual defense modifier.
